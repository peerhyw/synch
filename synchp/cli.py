...
from synchp.factory import get_broker, get_reader, get_writer, init
from synchp.replication.continuous import continuous_etl
from synchp.replication.etl import etl_full
from synchp.settings import Settings

logger = logging.getLogger("synchp.cli")
...
def produce(ctx: Context):
    ...
    reader.start_sync(broker, alias)
